			...
			<div class="row">
					...
					<div class="contact-number h1 ">
						...
						if (!isset($_SESSION['loggedIn'])) { ?>
							<div class="contact-number">
								...
								<span style="font-size:14px ;">+962 7 8848 4235</span>
							</div>
						<?php
						} else { ?>
				...
				<div class="col-md-4 col-xs-12 col-sm-4">
					...
					<div class="logo text-center">
						<a href="index.php">
							<!-- replace logo here -->
							<img class="img-responsive" src="images/new/cc.jpeg" alt="menu image" style="width: 340px; height:100px;" />
						</a>
					</div>
				</div>
