        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="block text-center " style="border:2px solid ;background-color:white;border-radius: 25px;">
                        ...
                        <form class="text-left clearfix" method="POST">
                            ...
                            <div class="text-center">
                                ...
                                <button class="btn btn-main" id="button" type="submit" name="admin_login" style="background-color:red;font-size:13px;border-radius :5px;">Log in</button>
                            </div>
                        </form>
                    </div>
                </div>
